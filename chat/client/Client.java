...
import main.java.chat.Connection;
import main.java.chat.ConsoleHelper;
import main.java.chat.Message;
import main.java.chat.MessageType;
...
public class Client {
        ...
        protected void clientHandshake() throws IOException, ClassNotFoundException {
            while (true) {
               ...
               if (message.getType() == MessageType.NAME_REQUEST) {
                   String clientName = Client.this.getUserName();
                   Message messageToSent = new Message(MessageType.USER_NAME, clientName);
    ...
    public void run() {
        ...
        while (clientConnected) {
            String readiedString = ConsoleHelper.readString();
           if (readiedString.equals("exit")) break;
           if (shouldSendTextFromConsole()) {
               sendTextMessage(readiedString);
           }
        }
    }
